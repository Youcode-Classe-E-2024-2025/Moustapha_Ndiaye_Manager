...
switch ($action) {
            ...
            <table class="min-w-full bg-white">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left">Recipes</th>
            ...
            <table class="min-w-full bg-white">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left">Commentss</th>
    ...
    case 'get_ingredients':
        ...
        <div class="overflow-x-auto">
            <div class="flex justify-between mb-4">
                <h2 class="text-2xl font-bold">Manage Ingrédients</h2>
        ...
        case 'get_comments':
            // Si la colonne archived existe maintenant, tu peux filtrer les comments non archivés
            ...
            if (empty($comments)) {
                ...
                <div class="overflow-x-auto">
                    <div class="flex justify-between mb-4">
                        <h2 class="text-2xl font-bold">Manage Comments</h2>
                    </div>
                    <table class="min-w-full bg-white">
                        <thead class="bg-gray-100">
                            <tr>
                                <th class="px-6 py-3 text-left">Contain</th>
                                <th class="px-6 py-3 text-left">Creation date</th>
                                <th class="px-6 py-3 text-left">Actions</th>
                            </tr>
                        </thead>
